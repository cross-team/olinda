      ...
      <Container as="section" className="page-legal" id="content" fluid>
        <Row className="justify-content-center">
          <Col sm={12} md={8} className="page-legal__content">
            ...
            <p>We want to ensure that communicating with us is easy and convenient.  If you encounter any issues, would like assistance, or have a recommendation for how we can improve, please contact us at <a href="mailto:accessibility@safrapay.com" aria-label="Contact email accessibility@safrapay.com">accessibility@safrapay.com</a> and <a href="tel:+18774723727" aria-label="Contact telelephone 1-877-472-3727">1-877-472-3727</a> and let us know.</p>
